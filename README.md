...
> **Status:** v0.0.1 — scaffolding. The reservation engine is being built per the phase plan in [brim.md](brim.md).

## Design documents

- [`brim.md`](brim.md) — positioning, competitor analysis, build phases.
