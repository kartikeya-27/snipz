...
> **Status:** v0.0.1 — scaffolding. The reservation engine is being built per the phase plan in [calyx.md](calyx.md).

## Design documents

- [`calyx.md`](calyx.md) — positioning, competitor analysis, build phases.
